...
If the server requires bearer tokens, set `OMC_ADMIN_TOKEN` for examples that configure
connections or OAuth clients. Set `OMC_RUNTIME_TOKEN` for examples that run `/v1`
actions.
