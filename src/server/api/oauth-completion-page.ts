...
const oauthCompletionStrings = {
  en: {
    ...
    bodyAfter: ". Return to OnMyCompany to continue.",
  ...
  "zh-CN": {
    ...
    title: "连接已就绪",
    bodyBefore: "已完成 ",
    bodyAfter: " 的授权，返回 OnMyCompany 继续。",
    closeButton: "关闭窗口",
    autoClose: "%N% 秒后自动关闭。",
  ...
  "zh-TW": {
    ...
    title: "連線已就緒",
    bodyBefore: "已完成 ",
    bodyAfter: " 的授權，返回 OnMyCompany 繼續。",
    closeButton: "關閉視窗",
    autoClose: "%N% 秒後自動關閉。",
...
<main class="card" role="status" aria-live="polite">
  <div class="header">
    ...
    <p><span data-t="bodyBefore">OAuth finished for </span><code>${escapedService}</code><span data-t="bodyAfter">. Return to OnMyCompany to continue.</span></p>
  </div>
  <div class="actions">
