      ...
      extraFields: [
        {
          ...
          description:
            "The HTTP or HTTPS URL of your Dokploy instance, without an API endpoint path. Public addresses work by default; private/overlay targets (RFC 1918, Tailscale, NetBird, private hostnames) require the self-hosted runtime to enable OMC_ALLOW_PRIVATE_NETWORK. Unsafe local, reserved, and cloud-metadata targets always remain blocked. See https://docs.dokploy.com/docs/core/api.",
        },
      ],
    },
  ],
