      ...
      extraFields: [
        {
          ...
          description:
            "The HTTP or HTTPS URL of your Gotify server. Public addresses work by default; private-network instances require the self-hosted runtime to enable OMC_ALLOW_PRIVATE_NETWORK. Unsafe local, reserved, and cloud-metadata targets remain blocked.",
        },
      ],
    },
  ],
