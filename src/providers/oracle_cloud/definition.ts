  ...
  auth: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "The PEM-encoded RSA private key paired with the configured OCI API key. OpenConnector treats this as a secret; configure OMC_ENCRYPTION_KEY to encrypt stored credentials at rest.",
        },
        {
