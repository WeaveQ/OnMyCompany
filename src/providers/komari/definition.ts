      ...
      extraFields: [
        {
          ...
          description:
            "The HTTP or HTTPS root URL of your Komari 1.3.2 or newer instance. Public addresses work by default; private-network targets require a self-hosted OpenConnector runtime with OMC_ALLOW_PRIVATE_NETWORK enabled. Loopback, link-local, reserved, and cloud-metadata targets remain blocked.",
        },
      ],
    },
  ],
