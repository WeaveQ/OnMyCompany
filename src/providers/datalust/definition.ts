      ...
      extraFields: [
        {
          ...
          description:
            "The HTTPS root URL of your Seq instance. Public addresses work by default; private-network targets require the self-hosted runtime to enable OMC_ALLOW_PRIVATE_NETWORK. Loopback, reserved, and cloud-metadata targets remain blocked.",
        },
      ],
    },
  ],
