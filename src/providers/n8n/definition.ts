      ...
      extraFields: [
        {
          ...
          description:
            "Your n8n instance URL, such as https://your-instance.app.n8n.cloud for n8n Cloud or your self-hosted public HTTPS base URL. LAN and overlay-network instances (including plain http://) require the deployment to set OMC_ALLOW_PRIVATE_NETWORK=true. URLs ending in /api/v1 are also accepted.",
        },
      ],
    },
  ],
