      ...
      extraFields: [
        {
          ...
          description:
            "The HTTP or HTTPS URL of your Octopus Deploy Cloud or self-hosted instance. Public addresses work by default; private-network instances require the self-hosted runtime to enable OMC_ALLOW_PRIVATE_NETWORK.",
        },
      ],
    },
  ],
