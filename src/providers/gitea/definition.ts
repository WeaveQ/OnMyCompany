      ...
      extraFields: [
        {
          ...
          description:
            "Gitea instance base URL, such as https://gitea.com or your self-hosted domain. URLs ending in /api/v1 are also accepted. Private/overlay targets and plain HTTP require the self-hosted runtime to enable OMC_ALLOW_PRIVATE_NETWORK.",
        },
      ],
    },
  ],
