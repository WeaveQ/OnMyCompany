...
//     OMC_ALLOW_PRIVATE_NETWORK (see isPrivateNetworkAccessAllowed).
//
 ...
 * through the `OMC_ALLOW_PRIVATE_NETWORK` environment variable.
 *
...
/** Parse the `OMC_ALLOW_PRIVATE_NETWORK` flag; only explicit truthy values enable it. */
